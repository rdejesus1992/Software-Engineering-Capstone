# This is the .py file that generates the webpage and GUI the users see and manipulate the data in. There is an
# interactive map as well as charts for easy comprehension. The idea behind this format was for users ease of access
# as well as being able to manage a database on a single page.
...
app.layout = html.Div([
    ...
    # div to hold radio items for filtering by rescue type
    html.Div([
    ...
    html.Br(),
    html.Hr(),
    # This div sets up the dashboard so that the
