# This .py file manages the CRUD functionality of the webpage, as well as accessing the data in the database for the
# user to easily work with. I wanted to make sure users could have access to the data and manipulate it as they needed.
