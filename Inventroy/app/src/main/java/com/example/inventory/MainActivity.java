...
public class MainActivity extends AppCompatActivity implements AddItemDialog.AddItemDialogListener, UpdateItemDialog.UpdateItemDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Inform users when inventory is at set stock level
        if (itemList.size() > 50) {
            Toast toast = Toast.makeText(getApplicationContext(), "The inventory is fully stocked", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
    ...
    public void onUpdateItemClick(int itemIndex, long id, String title, String quantity, String units) {
